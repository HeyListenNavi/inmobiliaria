        ...
        <div class="flex flex-col gap-10">
            <div class="flex items-center justify-between gap-2">
                <div class="flex flex-col gap-1">
                    <h1 class="text-headline-large font-[Raleway]">Nombre de casa</h1>
                    <h2 class="text-label-large font-normal text-gray-400">Tipo de casa</h2>
                </div>
            ...
            <h3 class="text-headline-medium font-normal">$123,456.00</h3>

            <div class="flex flex-col gap-4">
                <div class="flex flex-col gap-1">
                    <h4 class="text-body-medium font-normal text-gray-400">Subtitulo</h4>
                    <h1 class="text-body-large font-[Raleway]">Descripción</h1>
                </div>

                <p class="text-body-small text-gray-400">Lorem ipsum dolor sit amet consectetur, adipisicing elit. At
                    explicabo aut nemo eveniet ad, ea quisquam
                    blanditiis autem nostrum officiis corrupti. Dignissimos, corporis nobis totam architecto perferendis
                    unde adipisci ullam!</p>
            </div>
