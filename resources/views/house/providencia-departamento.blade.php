...
@section('hero')
    <div class="container mx-auto grid lg:grid-cols-2 gap-6 px-4 py-8">
        <div x-data="modelGallery([
            '{{asset("img/providencia/Providencia-Departamento.jpeg")}}',
            '{{asset("img/providencia/Providencia-Departamento-1.jpeg")}}',
            '{{asset("img/providencia/Providencia-Departamento-2.jpeg")}}',
            '{{asset("img/providencia/Providencia-Departamento-3.jpeg")}}',
            '{{asset("img/providencia/Providencia-Departamento-4.jpeg")}}',
            '{{asset("img/providencia/Providencia-Departamento-5.jpeg")}}',
        ...
        <div class="flex flex-col gap-10">
            <div class="flex items-center justify-between gap-2">
                <div class="flex flex-col gap-1">
                    <h1 class="text-headline-large font-[Raleway]">Providencia Departamento Remodelado</h1>
            ...
            <h3 class="text-headline-medium font-normal">$4,300,000.00</h3>
