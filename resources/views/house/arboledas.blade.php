...
@section('hero')
    <div class="container mx-auto grid lg:grid-cols-2 gap-6 px-4 py-8">
        <div x-data="modelGallery([
            '{{asset("img/arboledas/1.webp")}}',
            '{{asset("img/arboledas/2.webp")}}',
            '{{asset("img/arboledas/3.webp")}}',
            '{{asset("img/arboledas/4.webp")}}',
            '{{asset("img/arboledas/5.webp")}}',
            '{{asset("img/arboledas/6.webp")}}',
            '{{asset("img/arboledas/7.webp")}}'
        ...
        <div class="flex flex-col gap-10">
            <div class="flex items-center justify-between gap-2">
                <div class="flex flex-col gap-1">
                    <h1 class="text-headline-large font-[Raleway]">Amplia Casa Fracc. Arboledas, 240 m², 4 Recámaras, 4 1/2 Baños, Cocina Equipada</h1>
            ...
            <h3 class="text-headline-medium font-normal">$3,700,000.00</h3>
            ...
            <div class="flex flex-col gap-4">
                ...
                <p class="text-body-small text-gray-400">CASA EN VENTA $3,700,000.00 Precio Negociable
                    Ubicación: SM 500, Calle Granadillo, Fracc. Arboledas
                    Terreno de 160m2 Construcción: 240 m2
                    Excelente ubicación, céntrico punto estratégico para ir a cualquier parte de la Ciudad, amplias avenidas, supermercados, escuelas, Restaurantes, Centros Comerciales, Parque Kabah, etc.
                    Descripción
                    Casa de 2 Niveles, recientemente renovada, consta de amplia sala y comedor independientes, cocina equipada en acero inoxidable, barra y cantina, 4 recámaras y 4 1/2 baños, cuarto de lavado, patio, 1 cajón de estacionamiento. Aires acondicionados y ventiladores en todas las áreas. Caseta de seguridad.</p>
            </div>
