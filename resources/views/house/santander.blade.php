...
@section('hero')
    <div class="container mx-auto grid lg:grid-cols-2 gap-6 px-4 py-8">
        <div x-data="modelGallery([
            '{{asset("img/santander/1.jpg")}}',
            '{{asset("img/santander/2.webp")}}',
            '{{asset("img/santander/3.webp")}}',
            '{{asset("img/santander/4.jpg")}}',
            '{{asset("img/santander/5.jpg")}}',
            '{{asset("img/santander/6.webp")}}',
            '{{asset("img/santander/7.webp")}}',
            '{{asset("img/santander/8.webp")}}',
        ...
        <div class="flex flex-col gap-10">
            <div class="flex items-center justify-between gap-2">
                <div class="flex flex-col gap-1">
                    <h1 class="text-headline-large font-[Raleway]">Casa en Renta en San Pedro Garza García</h1>
            ...
            <h3 class="text-headline-medium font-normal">$180,000</h3>
            ...
            <div class="flex flex-col gap-4">
                ...
                <p class="text-body-small text-gray-400">Casa en Renta en San Pedro Garza García
                    765m2 de construcción en 964.97m2 de terreno
                    4 recamaras, con baño y vestidor
                    Cocina equipada
                    Area social con alberca y asador
                    Sótano con area para gimnasio, cine, bar y cuarto de visitas con baño completo.
                    Cochera para 4 autos</p>
            </div>
